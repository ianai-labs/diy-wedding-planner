        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 gap-6">
                <a href={route('reports.export-pdf')} className="rounded-lg bg-white p-6 shadow hover:shadow-md transition text-center">
                    ...
                    <h3 className="text-lg font-semibold text-gray-800">Export Checklist (PDF)</h3>
                    <p className="text-sm text-gray-500 mt-1">Unduh daftar task pernikahan Anda dalam format PDF</p>
                </a>
            </div>
        </div>
    </AuthenticatedLayout>);
