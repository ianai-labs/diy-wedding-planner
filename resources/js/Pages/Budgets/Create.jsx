...
export default function BudgetsCreate() {
    ...
    return (<AuthenticatedLayout><Head title="Tambah Budget" />
        <div className="max-w-2xl mx-auto space-y-6"><h2 className="text-2xl font-bold text-gray-800">Tambah Budget</h2>
            <form onSubmit={submit} className="space-y-4 rounded-lg bg-white p-6 shadow">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div><label className="block text-sm font-medium text-gray-700">Kategori</label>
                    ...
                    <div><label className="block text-sm font-medium text-gray-700">Jumlah (Rp)</label>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div><label className="block text-sm font-medium text-gray-700">Tanggal</label>
                ...
                <div><label className="block text-sm font-medium text-gray-700">Bukti Pembayaran</label>
                    <input type="file" onChange={(e) => setData('receipt', e.target.files[0])} className="mt-1 block w-full text-sm text-gray-500" accept=".jpg,.jpeg,.png" /></div>
                <div className="flex gap-3 justify-end">
                    ...
                    <button type="submit" disabled={processing} className="rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-500 disabled:opacity-50">Simpan</button>
                </div>
            </form>
        </div>
    </AuthenticatedLayout>);
