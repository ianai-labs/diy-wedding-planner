...
export default function AdminVendorsEdit({ vendor }) {
    ...
    return (<AuthenticatedLayout><Head title={`Edit: ${vendor.name}`} />
        <div className="max-w-2xl mx-auto space-y-6"><h2 className="text-2xl font-bold text-gray-800">Edit Vendor</h2>
            <form onSubmit={e => { e.preventDefault(); put(route('admin.vendors.update', vendor.id)); }} className="space-y-4 rounded-lg bg-white p-6 shadow">
